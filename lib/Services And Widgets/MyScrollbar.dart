...
/// widget in a [MyScrollbar] widget.
///
...
/// This sample shows a [MyScrollbar] that executes a fade animation as scrolling occurs.
...
class MyMaterialScrollbar extends RawScrollbar {
  const MyMaterialScrollbar({
    Key? key,
...
class _MaterialScrollbarState extends RawScrollbarState<MyMaterialScrollbar> {
